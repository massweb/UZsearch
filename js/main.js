       ...
       searchGoodPlaces:function(goodCoaches){
    	...
    	var Controller = Backbone.Router.extend({
            ...
            hider: function(){
                ...
                $('#orders_box').css("display","none");
                $('#search_box').css("display","none");

                $('#search_panel').find('li.tab').removeClass("active");
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $.each(data, function(index, value) {
                            ...
                            history_content+="<tr><td>"+(index+1)+".</td><td>"+value.title+"</td><td>"+my_date+"</td><td><button id='history_template_"+value.id+"' class='add ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only' role='button' history_id='"+value.id+"'aria-disabled='false'><span class='ui-button-text'>Применить</span></button></td></tr>";
                        });
